...
const bottt = (prefix) => {
return `
${a}Untuk Sekarang Bot Hanya Bisa Digunakan Di Group Karna,${a} \n*Kalian Yang Menggunakan Bot Terlalu Spam Nge(wedang jahe yuk) *

*NOTE:*
Jika Bot Ini Ada Di Grup, Dan Anda Admin Grup Suruh Aktifkan Bot Dengan Cara ${prefix}bott aktif
...
│✓ ${a}Pulsa: 085298595430${a}
|*donasi jika berkenan*
│✓ ${a}Gopay: 085298595430${a}
│ *jangan lupa jika mau invit di grup usahakan donasi terlebih dahulu jika ingin, jika tidak maka saya tidak memaksa*
┬
╰─────≽「 *BY ${name}* 」

...
├── _Example: ${prefix}quotemaker Bot/Saya/random_
┠≽ *${prefix}nulis text*
├── _Example: ${prefix}nulis Hay Bot_
┠≽ *${prefix}croman TEXT dan Friend*
├── _Example: ${prefix}croman Bot & Friend_
┠≽ *${prefix}slide TEXT*
├── _Example: ${prefix}slide Bot & Friend_
┠≽ *${prefix}trigger*
...
┠≽ *${prefix}ephoto 1 - 216*
├── _Example: ${prefix}ephoto 5 Bot_
┠≽ *${prefix}listtextpro*
├── _Example: untuk menampilkan list text pro_
┠≽ *${prefix}textpro 1 - 162*
├── _Example: ${prefix}textpro 1 Bot_
┠≽ *${prefix}fbgoldbutton TEXT*
├── _Example: ${prefix}fbgoldbutton Bot_
┠≽ *${prefix}tahta TEXT*
├── _Example: ${prefix}tahta Bot_
├── _Example: ${prefix}tts id Bot_
┠≽ *${prefix}ttp TEXT*
├── _Example: ${prefix}ttp Bot_
├───────────────────
┠≽ *${prefix}stiker*
